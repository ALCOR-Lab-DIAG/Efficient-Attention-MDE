...
class SAMMoHWindowAttention(nn.Module):
    ...
    def forward(self, x, v, mask=None):
        ...
        if self.routed_head > 0:
            ...
            if self.training:
                ...
                SAMMoHWindowAttention.SAM_LOAD_BALANCING_LOSSES.append(l_aux)
...
class SAMBLOCK(nn.Module):
    ...
    def __init__(self,
        ...
        self.attn = SAMMoHWindowAttention(
