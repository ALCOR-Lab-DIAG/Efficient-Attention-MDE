...
class NeWCFRsMoHWindowAttention(nn.Module):
    ...
    """
    NeWCFRs_LOAD_BALANCING_LOSSES = []
    def __init__(self, dim, window_size, num_heads, v_dim, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0., shared_head=0, routed_head=0):
    ...
    def forward(self, x, v, mask=None):
        ...
        if self.routed_head > 0:
            ...
            if self.training:
                ...
                NeWCFRsMoHWindowAttention.NeWCFRs_LOAD_BALANCING_LOSSES.append(l_aux)
...
class CRFBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, shared_head, routed_head,v_dim, window_size=7, shift_size=0,
        ...
        self.attn = NeWCFRsMoHWindowAttention(
            dim, window_size=to_2tuple(self.window_size), num_heads=num_heads, shared_head=shared_head, routed_head=routed_head,v_dim=v_dim,
